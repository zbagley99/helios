...
SCRAPER_REGISTRY: dict[str, dict] = {
    "hackernews": {"func": scrape_hackernews, "interval_minutes": 15},
    "reddit": {"func": scrape_reddit, "interval_minutes": 15},
    "news": {"func": scrape_news_rss, "interval_minutes": 30},
    "wikipedia": {"func": scrape_wikipedia, "interval_minutes": 60},
    "mastodon": {"func": scrape_mastodon, "interval_minutes": 15},
    "google": {"func": scrape_google_trends, "interval_minutes": 30},
}
